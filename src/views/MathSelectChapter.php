...
<body>
    ...
    <div class="main">
        <div class="titlebg">
            <h1 style="text-align:center; font-size:40px; color:#4c3228;">Mathematics</h1>
        </div>
        <table border=0 style="margin:50px auto; text-align: center;">
            <tr>
                <td>
                    <a <?php if (in_array("1",$chaplist)) {echo'href="MathChapter1Notes.php"';}?>>
                ...
                <td></td>
                <td>
                    <a <?php if (in_array("4",$chaplist)) {echo'href="MathChapter4Notes.php"';}?>>
                ...
                <td>
                    <a <?php if (in_array("5",$chaplist)) {echo'href="MathChapter5Notess.php"';}?>>
            ...
            <tr>
                <td>
                    <a <?php if (in_array("2",$chaplist)) {echo'href="MathChapter2Notes.php"';}?>>
                ...
                <td>
                    <a <?php if (in_array("3",$chaplist)) {echo'href="MathChapter3Notes.php"';}?>>
                        <div <?php if (in_array("3",$chaplist)) {echo'class="chapter1 unlock"';} else {echo 'class="chapter1"';}?>>3</div>
                    </a>
                </td>
                <td></td>
                <td>
                    <a <?php if (in_array("6",$chaplist)) {echo'href="MathChapter6Notes.php"';}?>>
