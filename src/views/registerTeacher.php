            ...
            <div class="form1">
                <div class="formAction">
                    ...
                    <div class="passwordInput">
                        ...
                        <input type="password" id="password" name="password2" requiredpattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*]).{6,}$">
                    </div>

                    <div class="icNumberInput">
                        <label for="icnumber">IC Number:</label>
                        <h4>Please enter your IC number in the format YYMMDDXXXXXX. WITHOUT -</h4>
                        <input type="text" id="icnumber" name="icnumber"  placeholder="Eg.030220201928" required required pattern="[0]{1}[0-9]{11}">
                    </div>
                ...
                <div class="formAction">
                    ...
                    <div class="profileInput2">
                        <div>
                            ...
                            <input type="text" id="region" name="region" placeholder="Eg.Selangor" required pattern="[A-Za-z ]+">
                        </div>
